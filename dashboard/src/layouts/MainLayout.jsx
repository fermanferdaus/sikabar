...
export default function MainLayout({ children }) {
  ...
  // ✅ Margin dinamis tergantung mode & sidebar
  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-[#f8fafc] text-gray-800 overflow-hidden">
      {/* === SIDEBAR === */}
      <Sidebar
        isOpen={sidebarOpen}
      ...
      >
        {/* === KONTEN HALAMAN === */}
        <main
          className="flex-1 w-full max-w-full px-3 sm:px-6 md:px-8 overflow-y-auto overflow-x-hidden transition-all duration-300 ease-in-out"
          style={{
