...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2025 at 06:02 PM
...
(34, 8, 1, 56, 55, '2025-11-11 13:29:57'),
...
(1, 'Admin Pusat', 'admin', '$2b$10$INGIMHQp7g3VqnkpuUEQd.eC/7AsfJ4ZTOENfR2wnHohkYUC69GA.', 'admin', NULL, NULL, '2025-11-11 02:18:05', NULL),
...
--
ALTER TABLE `stok_produk`
  MODIFY `id_stok` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `struk`
  MODIFY `id_struk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
